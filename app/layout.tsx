...
const DEFAULT_DESCRIPTION =
  "Solo founder shipping 7 SaaS products. 10 years designing for SaaS, AI, and DeFi at MarsX and Instadapp. Now building Mulu, Winery Hotels, Directory Launch, Momentum, AI Launch Space, PosteAhora and TravelApps — designed, coded, and launched solo from Buenos Aires.";
...
const personJsonLd = {
  ...
  description:
    "Solo founder, vibe-coder, and product designer with 10 years of experience designing SaaS, AI, and DeFi products. Currently shipping seven SaaS products end-to-end.",
  address: {
    "@type": "PostalAddress",
